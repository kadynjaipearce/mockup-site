    ...
    <nav className="sticky top-0 z-50 w-full bg-white/95 backdrop-blur-sm text-gray-800 shadow-lg border-b border-gray-100">
      <div className="max-w-6xl mx-auto flex items-center justify-between h-16 px-4 md:px-8">
        ...
        <Link href="/" className="flex items-center gap-2 font-bold text-xl">
          <RiLeafLine size={28} className="text-emerald-600" />
        ...
        <div className="hidden md:flex items-center gap-6">
          {navLinks.map((link) => (
            <Link
              key={link.href}
              href={"/"}
              className="relative px-2 py-1 transition-colors hover:text-emerald-600"
            >
          ...
          <motion.a
            ...
            className="ml-4 px-6 py-3 rounded-full bg-gradient-to-r from-emerald-600 to-emerald-700 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-200"
            whileHover={{
              scale: 1.05,
        ...
        {/* Mobile Hamburger */}
        <button
          className="md:hidden p-2 rounded focus:outline-none focus:ring-2 focus:ring-emerald-600"
        ...
        {mobileOpen && (
          ...
          >
            ...
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-4 px-6 py-3 rounded-full bg-gradient-to-r from-emerald-600 to-emerald-700 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-200"
              whileHover={{
                scale: 1.05,
                transition: { duration: 0.2 },
              }}
